...
- Use the versioned rubric (`hgm-infra/planning/lift-10of10-rubric.md`) as the source of truth; bump version on any rubric change.
- Keep Completeness/anti-drift checks in CI: toolchain pin alignment, schema-valid configs, coverage threshold floors,
  security config floors, and multi-module compile checks.
